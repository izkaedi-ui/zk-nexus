...
(function() {
    function runSetupCeremony() {
        ...
        const seedRaw = entropyInput ? entropyInput.value.trim() : "";
        
        // Fortify: Strip out potential script or HTML tags from raw user entropy seed
        const seed = seedRaw.replace(/<[^>]*>/g, "") || "0x" + Math.random().toString(16).substring(2, 10);
